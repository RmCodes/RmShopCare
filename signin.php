...
?>
				...
				<input type="text" id="tb-box" name="username" class="name" placeholder="" required="">
				<div class="clearfix"></div>
			</div>
			<div class="password-agileits">
				<span class="username">Password:</span>
				<input type="password" id="tb-box" name="password" class="password" placeholder="" required="">
				<div class="clearfix"></div>
			</div>
       ...
       <a href="singup.php"><font color="#FF0000">SignUp Here...</font></a>
				<div class="back">
