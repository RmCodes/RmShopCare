<?php
        ...
        {
            $SQL = "SELECT * FROM  category_master WHERE cat_name LIKE '%".$_POST['searchtxt']."%' OR pro_name LIKE '%".$_POST['searchtxt']."%'";
        }
        ...
        if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
        {
            $query = "SELECT COUNT(*) as num FROM  category_master WHERE cat_name LIKE '%".$_POST['searchtxt']."%' OR ro_name LIKE '%".$_POST['searchtxt']."%'";
        }
        ...
        if($page)
            ...
            $start = 0;
        $sql = "SELECT * FROM category_master LIMIT $start, $limit ";
        if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
        {
            $sql= "SELECT * FROM  category_master WHERE cat_name LIKE '%".$_POST['searchtxt']."%' OR pro_name LIKE '%".$_POST['searchtxt']."%' LIMIT $start, $limit";
        }
...
<input class="btn btn-primary dropdown-toggle" name="dsubmit" type="button" value="Delete Selected" style="margin-left:5px;" onClick="return confirmDeleteSubmit()"/>
                ...
                <div class="row">
                       ...
                       <!-- <form role="form" name="deletefiles" action="delet.php" method="post" >
                            <input name="table" type="hidden" value="category_master">
                                                    ...
                                                    <div>
                                                        <table class="table-bordered table-hover table-striped" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th align="center">Categories Name</th>
                                                                <th align="center">Product Name</th>
                                                                <th align="center">Type</th>
                                                                <th align="center">Second Type </th>
 ...
 <td align="center"> <a href="edit.php?cat_id=<?php echo $row['cat_id'];?>"><span class=" glyphicon glyphicon-pencil"></span></a></td>
   <td align="center"><a onClick="return confirmSubmit()" href="delete.php?cat_id=<?php echo $row['cat_id']; ?>&table=category&return=category.php"><span class="glyphicon glyphicon-trash"></span></a></td>
                                                                    <td align="center" ><input  type="checkbox" value="<?php echo $row['cat_id']; ?>" name="checklist[]" /></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                            ?>
