...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index2.php">Home</a><i class="fa fa-angle-right"></i>Tabels</li>
            </ol>
<div class="agile3-grids">
		
		<div class="grid_2 grid_4 w3_agileits_icons_page">
						<div class="icons">
							<h2 class="agileits-icons-title">Product Categories List</h2>
							<section id="new">
